...
public abstract class Factory implements Graph{
	...
	public static Graph createGraphFromMap(String fileName) throws IOException {
		Parser p = new Parser();
		HashMap<Long,Node> nodes = p.parseMap(fileName);
		

		return new ConcreteGraph(nodes, p.getNumNodesRead(), p.getNumEdgesRead());
	}
	...
	public static NodeFinder createNodeFinder(Graph g) {
		...
		return new ConcreteNodeFinder(g);
	}
